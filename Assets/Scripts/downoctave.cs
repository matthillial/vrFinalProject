...
public class downoctave : MonoBehaviour
{
    ...
    void Update()
    {
        if (clicked)
        {
            ...
            if (pad.GetComponent<oneshot_pad>().cur_note <= 11)
            {
            ...
            {
                pad.GetComponent<oneshot_pad>().cur_note = pad.GetComponent<oneshot_pad>().cur_note - 12;
                clicked = false;
            }
        }
